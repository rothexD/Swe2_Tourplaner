...
namespace Swe2_tour_planer.Commands
{
    class UpdateTourCommand : ICommand
    {
        ...
        private readonly ServicesAccess _service;
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public UpdateTourCommand(UpdateTourViewModel tourViewModel, HomeViewModel home, SwitchViewCommand switchView, ServicesAccess service)
        {
            _HomeViewModel = home;
